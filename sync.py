...
from spotify_api import (
    get_all_playlists, get_playlist_tracks, get_liked_tracks,
    get_artists
)
from db_utils import (
    get_session, save_artist, save_album, save_track, save_playlist,
    add_track_to_playlist, get_last_sync,
    log_sync_start, log_sync_complete
)

def sync_liked_tracks(spotify: spotipy.Spotify, session: Session = None) -> int:
    """
    ...
    try:
        ...
        print(f"Liked tracks sync complete. Added/updated: {tracks_synced}, Skipped: {tracks_skipped}")
...
def sync_playlists(spotify: spotipy.Spotify, session: Session = None) -> int:
    """
    ...
    try:
        ...
        print(f"Playlist sync complete. Playlists: {playlists_synced}, Tracks: {tracks_synced}")
...
def sync_all(spotify: spotipy.Spotify, session: Session = None) -> Dict[str, int]:
    """
